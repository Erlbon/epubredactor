"""Tests for core/undo.py, using real EpubBook instances (via a synthetic
epub) rather than mocks, so snapshot/restore is exercised against the
actual object shape."""
import os
import sys
import zipfile
...
from core.undo import UndoManager  # noqa: E402
