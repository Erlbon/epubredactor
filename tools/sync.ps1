<#
.SYNOPSIS
    Syncs C:\Dev\epubredactor from the newest epubredactor*.zip drop in
...
.EXAMPLE
    powershell -File tools\sync.ps1 -ZipPath "C:\Temp\_AI Coding\epubredactor_with_redactor_common.zip"
.EXAMPLE
...
& "C:\Dev\_shared-tools\sync-from-zip.ps1" `
    ...
    -ZipNamePattern "epubredactor" `
    -RepoPath "C:\Dev\epubredactor" `
    -ProjectDirName "epubredactor" `
    -Marker "main.py" `
    -NoPush:$NoPush
